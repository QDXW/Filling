...
/******************************************************************************/
void Infusion_Air_70ul(void)
{
#if CH1_ENABLED
	Movement_M10_GotoTarget(DIR_CCW, Infusion_Air_70ul_1ml);
	Movement_M3_GotoTarget(DIR_CCW, Infusion_Air_70ul_1ml);
	Movement_M6_GotoTarget(DIR_CCW, Infusion_Air_70ul_5ml);

	/* @TODO */
	Movement_M1_GotoTarget(DIR_CCW, Infusion_Air_70ul_5ml);
	Movement_M4_GotoTarget(DIR_CCW, Infusion_Air_70ul_5ml);
...
#if CH2_ENABLED
	Movement_M10_GotoTarget(DIR_CCW, Infusion_Air_70ul_1ml);
	Movement_M3_GotoTarget(DIR_CCW, Infusion_Air_70ul_5ml);
	Movement_M6_GotoTarget(DIR_CCW, Infusion_Air_70ul_5ml);
	Movement_M1_GotoTarget(DIR_CCW, Infusion_Air_70ul_5ml);
