...
void Injucet_Volume1 (void)
{
	...
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_R1);
}
...
void Injucet_Volume2 (void)
{
	...
	Comm_CanDirectSend(STDID_SEND_BUMP_VOL,MBuffer,3);
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_R2);
}
...
void Injucet_Volume3 (void)
{
	...
	Comm_CanDirectSend(STDID_SEND_BUMP_VOL,MBuffer,3);
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_M);
}
...
void Injucet_Volume4 (void)
{
	...
	Comm_CanDirectSend(STDID_SEND_BUMP_VOL,MBuffer,3);
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_W1);
}
...
void Injucet_Volume5 (void)
{
	...
	Comm_CanDirectSend(STDID_SEND_BUMP_VOL,MBuffer,3);
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_W2);
}
...
void Injucet_Volume6 (void)
{
	...
	Comm_CanDirectSend(STDID_SEND_BUMP_VOL,MBuffer,3);
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_W3);
}
...
void Injucet_Volume7 (void)
{
	...
	Comm_CanDirectSend(STDID_SEND_BUMP_VOL,MBuffer,3);
	Delay_ms_SW(2);
	HostComm_Cmd_Send_RawData(2, sBuffer,CMD_CODE_INJUCET_VOLUME_W4);
}
